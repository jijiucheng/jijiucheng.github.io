...
```swift
/// CBR 模式，固定比特率
+ (NSString *)audioToMP31: (NSString *)sourcePath samplerate:(int)samplerate bitRate:(int)bitRate isDeleteSourchFile:(BOOL)isDelete {
...
```swift
/// VBR 模式，动态比特率
+ (NSString *)audioToMP32: (NSString *)sourcePath samplerate:(int)samplerate bitRate:(int)bitRate isDeleteSourchFile:(BOOL)isDelete {
